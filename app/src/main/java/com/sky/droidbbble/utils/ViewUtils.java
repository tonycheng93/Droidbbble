...
public final class ViewUtils {
    ...
    public static boolean isNavBarOnBottom(@NonNull Context context) {
        ...
        boolean canMove = (displayMetrics.widthPixels != displayMetrics.heightPixels
    ...
    public static final Property<View, Integer> BACKGROUND_COLOR
            = AnimUtils.createIntProperty(new AnimUtils.AbstractIntProp<View>("backgroundColor") {
        @Override
    ...
    public static final Property<TextView, Integer> TEXT_COLOR
            = AnimUtils.createIntProperty(new AnimUtils.AbstractIntProp<TextView>("textColor") {
        @Override
    ...
    public static final Property<Drawable, Integer> DRAWABLE_ALPHA
            = AnimUtils.createIntProperty(new AnimUtils.AbstractIntProp<Drawable>("alpha") {
        @Override
    ...
    public static final Property<ImageView, Integer> IMAGE_ALPHA
            = AnimUtils.createIntProperty(new AnimUtils.AbstractIntProp<ImageView>("imageAlpha") {
        @Override
