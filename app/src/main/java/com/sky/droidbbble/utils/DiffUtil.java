...
public class DiffUtil {
     ...
     * @return A DiffResult that contains the information about the edit sequence to convert the old
    ...
    public static class DiffResult {
        ...
        /**
         * Dispatches the update events to the given adapter. <p> For example, if you have an {@link
         * android.support.v7.widget.RecyclerView.Adapter Adapter} that is backed by a {@link List},
         * you can swap the list with the new one then call this method to dispatch all updates to
         * the RecyclerView.
         * <pre>
         ...
         * </pre>
         * <p> Note that the RecyclerView requires you to dispatch adapter updates immediately when
         * you change the data (you cannot defer {@code notify*} calls). The usage above adheres to
         * this rule because updates are sent to the adapter right after the backing data is
         * changed, before RecyclerView tries to read it. <p> On the other hand, if you have another
         ...
         * on, one by one. If you have such an {@link android.support.v7.widget.RecyclerView.AdapterDataObserver
         * AdapterDataObserver}, you can use {@link #dispatchUpdatesTo(ListUpdateCallback)} to
         * handle each modification manually.
         *
